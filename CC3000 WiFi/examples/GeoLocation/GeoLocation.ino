/*************************************************** 
  This is an example for the Tinysine CC3000 Wifi Shield

  ----> https://www.tinysine.com
...
Tinysine_CC3000 cc3000 = Tinysine_CC3000(Tinysine_CC3000_CS,
  Tinysine_CC3000_IRQ, Tinysine_CC3000_VBAT,
  SPI_CLOCK_DIV2); // you can change this clock speed

#define WLAN_SSID       "Aurora"   // cannot be longer than 32 characters!
#define WLAN_PASS       "63Fj*4Jbe"
// Security can be WLAN_SEC_UNSEC, WLAN_SEC_WEP, WLAN_SEC_WPA or WLAN_SEC_WPA2
#define WLAN_SECURITY   WLAN_SEC_WPA2

Tinysine_CC3000_Client client;
...
// Helper functions swiped from Tinysine 'Gutenbird' code (with changes)
