...
//#define WLAN_PASS       "ymxu3607"

#define WLAN_SSID       "Aurora"        // cannot be longer than 32 characters!
#define WLAN_PASS       "63Fj*4Jbe"

#define WLAN_SSID       "Impala"        // cannot be longer than 32 characters!
#define WLAN_PASS       "1MLqJfT3"
//const char WLAN_PASS[] = {0x1M, 0xLq, 0xJf, 0xT3, 0x00};
...
*/
  ...
  */
  ...
  uint32_t ip = 0;
  Serial.print(F("www.adafruit.com -> 207.58.139.247"));
  while  (ip  ==  0)  {
