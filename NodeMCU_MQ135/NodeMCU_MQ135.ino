...
Serial.print("rzero reading = ");

Serial.println(rzero, DEC); // this to display the rzero value continuously, uncomment this to get ppm value

Serial.print("ppm  =  ");

Serial.println(ppm, DEC); // this to display the ppm value continuously, uncomment this to get rzero value
